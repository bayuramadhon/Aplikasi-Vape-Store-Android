...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView txtketerangan;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            getSupportActionBar().setTitle("Vape Store");
            ...
            btnproses.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(edtnamapel.getText().toString().length()==0){
                        edtnamapel.setError(" Nama harus di isi");
                    }else if(edtnamabar.getText().toString().length()==0){
                        edtnamabar.setError("Nama Barang harus di isi");
                    }else  if(edtjumlahbel.getText().toString().length()==0){
                        edtjumlahbel.setError("Jumlah beli harus di isi");
                    }else if(edtharga.getText().toString().length()==0){
                        edtharga.setError(" Harga harus di isi");
                    }else if(edtuangbay.getText().toString().length()==0) {
                        edtuangbay.setError("Uang bayar harus di isi");
                    }else {
                    ...
                    if (total > 100000) {
                        txtbonus.setText("Bonus : RDA Artha Coil");
                    } else if (total > 80000) {
                        txtbonus.setText("Bonus : Liquid Runa ChesseCake");
                    } else if (total > 50000) {
                        txtbonus.setText("Bonus : Liquid Juice Mango");
                    } else {
